...
パス内の特殊文字（日本語、スペース、括弧など）は、Markdownリンクとして正しく機能するようにURLエンコードされます。

- 各パス要素を個別にエンコード（パス区切り `/` は保持）
- 括弧 `(` と `)` は明示的に `%28` と `%29` にエンコード
- 相対パスマーカー `.` と `..` はエンコードしない

**例:**
```
入力: [[テストページ]]
出力: [テストページ](%E3%83%86%E3%82%B9%E3%83%88%E3%83%9A%E3%83%BC%E3%82%B8.md)

入力: [[ファイル (1)]]
出力: [ファイル (1)](%E3%83%95%E3%82%A1%E3%82%A4%E3%83%AB%20%281%29.md)
```
...
現在のページ: プロジェクト/タスク
リンク: [[プロジェクト/概要]]
出力: [プロジェクト/概要](%E6%A6%82%E8%A6%81.md)
```
...
現在のページ: トップページ
リンク: [[プロジェクト/タスク]]
出力: [プロジェクト/タスク](%E3%83%97%E3%83%AD%E3%82%B8%E3%82%A7%E3%82%AF%E3%83%88/%E3%82%BF%E3%82%B9%E3%82%AF.md)
```
...
現在のページ: プロジェクト/タスク
リンク: [[トップページ]]
出力: [トップページ](../%E3%83%88%E3%83%83%E3%83%97%E3%83%9A%E3%83%BC%E3%82%B8.md)
```
...
現在のページ: プロジェクトA/タスク
リンク: [[プロジェクトB/概要]]
出力: [プロジェクトB/概要](../%E3%83%97%E3%83%AD%E3%82%B8%E3%82%A7%E3%82%AF%E3%83%88B/%E6%A6%82%E8%A6%81.md)
```
...
添付ファイルのパスも内部リンクと同様にURLエンコードされます。これにより、ファイル名に特殊文字（日本語、スペース、括弧など）が含まれていても、Markdownリンクとして正しく機能します。

**例:**
```
ページ名: テスト
入力: #ref(画像 (1).png)
出力: ![画像 (1).png](%E3%83%86%E3%82%B9%E3%83%88_attachment_%E7%94%BB%E5%83%8F%20%281%29.png)
```
...
出力: ![screenshot.png](%E6%A6%82%E8%A6%81_attachment_screenshot.png)

入力: #ref(画面.png,スクリーンショット)
出力: ![スクリーンショット](%E6%A6%82%E8%A6%81_attachment_%E7%94%BB%E9%9D%A2.png)
```
...
出力: <img src="%E3%83%9A%E3%83%BC%E3%82%B8%E5%90%8D_attachment_%E3%83%95%E3%82%A1%E3%82%A4%E3%83%AB%2C%20%E5%90%8D%E5%89%8D.png" alt="ファイル, 名前.png" width="300" height="200">

入力: #ref("引用符""含む"".png")
出力: ![引用符"含む".png](%E3%83%9A%E3%83%BC%E3%82%B8%E5%90%8D_attachment_%E5%BC%95%E7%94%A8%E7%AC%A6%22%E5%90%AB%E3%82%80%22.png)
```
...
出力: ![diagram.png](%E6%A6%82%E8%A6%81/%E6%A6%82%E8%A6%81_attachment_diagram.png)

現在のページ: プロジェクト/タスク
入力: #ref(../header.png)
出力: ![header.png](../%E3%83%97%E3%83%AD%E3%82%B8%E3%82%A7%E3%82%AF%E3%83%88_attachment_header.png)

現在のページ: プロジェクト/タスク
入力: #ref(./footer.png)
出力: ![footer.png](%E3%82%BF%E3%82%B9%E3%82%AF_attachment_footer.png)
```

**注意:** 添付ファイルのパスも相対パスとして計算され、URLエンコードされます。

#### 5.5.2 非画像ファイル参照

非画像ファイルの場合もファイル名がデフォルトのリンクテキストとして使用され、パスはURLエンコードされます。
...
ページ名: テスト
入力: #ref(資料.pdf)
出力: [資料.pdf](%E3%83%86%E3%82%B9%E3%83%88_attachment_%E8%B3%87%E6%96%99.pdf)

入力: #ref("仕様書 (最新).xlsx",仕様書)
出力: [仕様書](%E3%83%86%E3%82%B9%E3%83%88_attachment_%E4%BB%95%E6%A7%98%E6%9B%B8%20%28%E6%9C%80%E6%96%B0%29.xlsx)
```
